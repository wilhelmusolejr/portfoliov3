...
import test from "../assets/me/test.jpg";
...
export default function About() {
  ...
  //     type: ["design"],
  //     file: {
  //       intro: nft, // Changed to actual import
  //       portfolio: nft,
  //     },
  //     project_showcase: 5,
  //     link: {
  ...
  //     file: {
  //       intro: null,
  //       portfolio: money_tracker_v1, // Ensure this import is defined
  //     },
  //     project_showcase: null,
  //     link: {
  ...
  //     type: ["develop", "design"],
  //     file: {
  //       intro: shopeeling, // Changed to actual import
  ...
  //     type: ["develop", "design"],
  //     file: {
  //       intro: clinic, // Changed to actual import
  //       portfolio: clinic,
  //     },
  //     project_showcase: 2,
  //     link: {
  ...
  //     type: ["develop", "design"],
  //     file: {
  //       intro: pennywise, // Changed to actual import
  //       portfolio: pennywise,
  //     },
  //     project_showcase: 4,
  //     link: {
  ...
  //     type: ["develop", "design"],
  //     file: {
  //       intro: mobhie, // Changed to actual import
  //       portfolio: mobhie,
  //     },
  //     project_showcase: 1,
  //     link: {
